...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { description: @visitor.description, title: @visitor.title } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { description: @visitor.description, title: @visitor.title } }
